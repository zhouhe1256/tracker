...
import com.gracecode.tracker.ui.fragment.AltitudeChartsFragment;
import com.gracecode.tracker.ui.fragment.AltitudeNewChartsFragment;
...
public class AltitudeiCharts extends Activity {
    private String archiveFileName;
    private Archiver archiver;
    private String description;
    private LinearLayout chartsView;
    private ArchiveMeta archiveMeta;
    private AltitudeNewChartsFragment speedChartsFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        speedChartsFragment = new AltitudeNewChartsFragment(context, archiver);
