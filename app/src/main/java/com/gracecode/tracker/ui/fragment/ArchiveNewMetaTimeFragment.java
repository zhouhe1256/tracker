...
public class ArchiveNewMetaTimeFragment extends Fragment {
    ...
    public ArchiveNewMetaTimeFragment(Context context, ArchiveMeta meta) {
        this.meta = meta;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        metaLayout = inflater.inflate(R.layout.archive_new_meta_time, container, false);
